...
const AddressAreasManagement: React.FC = () => {
  ...
  const handleOpenForm = (area: any = null) => {
    if (area) {
    ...
    <div className="page-container">
      <div className="container-main">
        <div className="mb-3xl flex justify-between items-start">
          <div>
            <h1 className="section-title mb-md">Address Areas</h1>
...
export default AddressAreasManagement;
